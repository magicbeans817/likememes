...
# This Jupyter notebook is used to extract useful information from data obtained by Downloader. First, we must load few necessary packages:
...
# We created a class "Summary". This function contains several useful attributes, which we can use to gain insight into structure of our data:
# - okomentovat jednotlivy atributy
